...
which - program to do something

# SYNOPSIS

**which** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**which** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **which** and **bar** commands.
...
:   The system-wide configuration file to control the behaviour of
    which. See **foo.conf**(5) for further details.
...
**which** provides some return codes, that can be used in scripts:
